...
<script src="<?php echo $siteurl;?>js/jquery-migrate-3.0.1.min.js"></script>
...
<script src="<?php echo $siteurl;?>js/jquery.animateNumber.min.js"></script>
<script src="<?php echo $siteurl;?>js/bootstrap-datepicker.js"></script>
<script src="<?php echo $siteurl;?>js/scrollax.min.js"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="<?php echo $siteurl;?>js/google-map.js"></script>
